...
__decorate([
    (0, mongoose_1.Prop)({ enum: ['pending', 'paid'], default: 'paid' }),
    __metadata("design:type", String)
], Ticket.prototype, "paymentStatus", void 0);
__decorate([
    (0, mongoose_1.Prop)({ enum: ['not_attended', 'attended'], default: 'not_attended' }),
    __metadata("design:type", String)
], Ticket.prototype, "attendanceStatus", void 0);
